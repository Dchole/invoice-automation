          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-5">
            ...
            <div
              ...
              style={{
                ...
                border: "1px solid var(--color-status-blue-border)"
              }}
            >
              <p
                className="text-2xl font-bold"
            ...
            <div
              ...
              style={{
                backgroundColor:
                  "var(--color-status-purple-bg, var(--color-status-blue-bg))",
                border:
                  "1px solid var(--color-status-purple-border, var(--color-status-blue-border))"
              }}
            >
              <p
                className="text-2xl font-bold"
                style={{
                  fontFamily: "var(--font-heading)",
                  color: "var(--color-status-purple, var(--color-status-blue))"
                }}
              >
